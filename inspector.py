...
# The Main Class     
class Inspector():
    def __init__(self, path: str = "mypath", enable_report: bool = True, json_path:str = "my_json_file"):
        self.path = path
        self.json_path = json_path
    ...
    def run(self) -> bool:
        ...
        if self.enable_report == True:
            # create the report
            report_gen = ReportGen(self.json_path , self.report , self.result , self.path ,self.failed_check)
            report_gen.run()
